		...
		<div class="row">
			<div class="col-12 col-lg-8">
				...
				<div class="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="100ms">
					<!-- Room Thumbnail -->
					<div class="room-thumbnail"><img alt="" src="/horizon/img/bg-img/orange.jpg" /></div>
					<!-- Room Content -->

					<div class="room-content">
						<h2>Orange Suite</h2>

						<h4>₦60,000 <span>/ Night</span></h4>
				...
				<div class="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="300ms">
					<!-- Room Thumbnail -->
					<div class="room-thumbnail"><img alt="" src="/horizon/img/business/b3.jpg" /></div>
					<!-- Room Content -->

					<div class="room-content">
						<h2>Business Suite</h2>

						<h4>₦23,500 <span>/ Night</span></h4>
						...
						<a class="btn view-detail-btn" href="business">View Details </a>
					</div>
				</div>
				<!-- Single Room Area -->
				...
				<div class="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="300ms">
					<!-- Room Thumbnail -->
					<div class="room-thumbnail"><img alt="" src="/horizon/img/cs/22.jpg" /></div>
					<!-- Room Content -->
					...
					<div class="room-content">
						...
						<a class="btn view-detail-btn" href="classic">View Details </a>
					</div>
				</div>
				<!-- Single Room Area -->
				...
				<div class="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="500ms">
					<!-- Room Thumbnail -->
					<div class="room-thumbnail"><img alt="" src="/horizon/img/regular/41.jpg" /></div>
					<!-- Room Content -->

					<div class="room-content">
						<h2>Regular Double</h2>

						<h4>₦15,000 <span>/ Night</span></h4>
						...
						<a class="btn view-detail-btn" href="regular">View Details </a>
					</div>
				</div>
				<!-- Single Room Area -->
				...
				<div class="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="700ms">
					<!-- Room Thumbnail -->
					<div class="room-thumbnail"><img alt="" src="horizon/img/bg-img/royal.jpg" /></div>
					<!-- Room Content -->

					<div class="room-content">
						<h2>Purple Deluxe Suite</h2>

						<h4>₦30,000 <span>/ Night</span></h4>
						...
						<a class="btn view-detail-btn" href="purple">View Details </a>
					</div>
				</div>
				<!-- Single Room Area -->
				...
				<div class="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="900ms">
					<!-- Room Thumbnail -->
					<div class="room-thumbnail"><img alt="" src="/horizon/img/bg-img/classic.jpg" /></div>
					<!-- Room Content -->

					<div class="room-content">
						<h2>Green Deluxe Suite</h2>

						<h4>₦28,000 <span>/ Night</span></h4>
						...
						<a class="btn view-detail-btn" href="green">View Details </a>
					</div>
				</div>
				<!-- Single Room Area -->
				...
				<div class="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="900ms">
					<!-- Room Thumbnail -->
					<div class="room-thumbnail"><img alt="" src="/horizon/img/rs/32.jpg" /></div>
					<!-- Room Content -->

					<div class="room-content">
						<h2>Royal Suite</h2>

						<h4>₦80,000 <span>/ Night</span></h4>
						...
						<a class="btn view-detail-btn" href="royal">View Details </a>
					</div>
				</div>
				<!-- Single Room Area -->
					...
					<form action="{{ route('get-booking') }}" method="post">
						...
						<div class="form-group mb-30"><label for="checkInDate">Date</label>
							...
							<div class="input-daterange" id="datepicker">
								<div class="row no-gutters">
									<div class="col-6"><input class="input-small form-control" id="checkin" name="check_in" placeholder="Check In" value="{{ old('check_in') }}" type="text" />
										<span class="text-danger">@error ('check_in') {{$message}} @enderror</span>
									</div>

									<div class="col-6"><input class="input-small form-control" name="check_out" value="{{ old('check_out') }}" placeholder="Check Out" type="text" />
						...
						<div class="form-group mb-30"><label>Details</label>
							...
							<div class="row no-gutters">
								...
								<div class="col-6"><input class="input-small form-control" name="phone" placeholder="Phone No:" value="{{ old('phone') }}" type="text" />
						...
						<div class="form-group mb-30">
							<div class="row">
								<div class="col"><input class="input-small form-control" name="email" placeholder="Email:" type="text" value="{{ old('email') }}" />
						...
						<div class="form-group"><button class="btn roberto-btn w-100" type="submit">Book Now</button></div>
					</form>
				</div>
			</div>
		</div>
