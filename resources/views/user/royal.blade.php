            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title">Royal Suite View</h2>
                        <h2 class="room-price">₦80,000 <span>/ Per Night</span></h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div id="room-thumbnail--slide" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="/horizon/img/rs/31.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="/horizon/img/rs/32.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="/horizon/img/rs/33.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="/horizon/img/rs/34.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="/horizon/img/rs/35.jpg" class="d-block w-100" alt="">
                                    </div>
                                </div>
                    ...
                    <div class="hotel-reservation--area mb-100">
                        <form action="http://www.horizonsuites.com.ng/reservation.php" method="post">
                            <div class="form-group mb-30">
                                ...
                                <div class="input-daterange" id="datepicker">
                                    <div class="row no-gutters">
                                        <div class="col-6">
                                            <input type="text" class="input-small form-control" name="checkin" id="checkin" placeholder="Check In">
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="input-small form-control" name="checkout" name="checkout" placeholder="Check Out">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mb-30">
                                ...
                                <div class="row no-gutters">
                                <div class="col-6">
                                     <input type="text" class="input-small form-control" name="name" placeholder="Enter name">
                                </div>
                                <div class="col-6">
                                     <input type="text" class="input-small form-control" name="phone" placeholder="Phone No:">
                                </div>
                                </div>
                            </div>
                            <div class="form-group mb-30">
