...
<section class="welcome-area">
    <div class="welcome-slides owl-carousel">
        ...
        <div class="single-welcome-slide bg-img bg-overlay" data-img-url="/horizon/img/bg-img/16.jpg" style="background-image: url(/horizon/img/bg-img/16.jpg);">
            <!-- Welcome Content -->
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12">
                            <div class="welcome-text text-center">
                                ...
                                <a class="btn roberto-btn btn-2" data-animation="fadeInLeft" data-delay="800ms" href="/booking">Book Online</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Single Welcome Slide -->
        <div class="single-welcome-slide bg-img bg-overlay" data-img-url="/horizon/img/bg-img/17.jpg" style="background-image: url(/horizon/img/bg-img/17.jpg);">
            <!-- Welcome Content -->
            <div class="welcome-content h-100">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12">
                            <div class="welcome-text text-center">
                                ...
                                <a class="btn roberto-btn btn-2" data-animation="fadeInUp" data-delay="800ms" href="/booking">Book Online</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="single-welcome-slide bg-img bg-overlay" data-img-url="/horizon/img/bg-img/17.jpg" style="background-image: url(/horizon/img/classic/59.jpg);">
            <!-- Welcome Content -->
            <div class="welcome-content h-100">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
        ...
        <div class="single-welcome-slide bg-img bg-overlay" data-img-url="/horizon/img/bg-img/19.jpg" style="background-image: url(/horizon/img/bg-img/19.jpg);">
            <!-- Welcome Content -->
            <div class="welcome-content h-100">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
        ...
        <div class="single-welcome-slide bg-img bg-overlay" data-img-url="/horizon/img/bg-img/141.jpg" style="background-image: url(/horizon/img/bg-img/141.jpg);">
            <!-- Welcome Content -->
            <div class="welcome-content h-100">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12">
                            <div class="welcome-text text-center">
                                ...
                                <a class="btn roberto-btn btn-2" data-animation="fadeInDown" data-delay="800ms" href="/booking">Book Online</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="hotel-search-form">
                <form action="{{ route('get-booking') }}" method="post">
                    ...
                    <div class="row justify-content-between align-items-end">
                        <div class="col-6 col-md-2 col-lg-3"><label for="name">Name</label> <input class="form-control" id="name" name="name" type="text" />
                        ...
                        <div class="col-6 col-md-2 col-lg-3"><label for="num">Phone No:</label> <input class="form-control" id="phone" name="phone" type="text" />
                            {{-- <span class="text-danger">
                                    @error('phone')
                                        {{ $message }}
                            @enderror
                        ...
                        <div class="col-6 col-md-2 col-lg-3"><label for="email">E-mail</label> <input class="form-control" id="email" name="email" type="text" />
                            {{-- <span class="text-danger">
                                    @error('email')
                                        {{ $message }}
                            @enderror
                        ...
                        <div class="col-6 col-md-2 col-lg-3"><label for="roomtype">Room Type</label>
                            <select class="form-control" placeholder="Select Category" name="room_type" id="sub_category_name">
                        ...
                        <div class="col-6 col-md-2 col-lg-3"><label for="checkin">Check In</label>
                            <input class="form-control" type="date" id="checkin" name="check_in" placeholder="Check In" value="{{ old('check_in') }}" type="text" />
                            {{-- <span class="text-danger">
                                    @error('check_in')
                                        {{ $message }}
                            @enderror
                        ...
                        <div class="col-6 col-md-2 col-lg-3"><label for="checkout">Check Out</label>
                            <input class="form-control" type="date" name="check_out" value="{{ old('check_out') }}" placeholder="Check Out" type="text" />
                            {{-- <span class="text-danger">
                                    @error('check_out')
                                        {{ $message }}
                            @enderror
                        ...
                        <div class="col-12 col-md-3"><button class="form-control btn roberto-btn w-100" type="submit">Book Now</button></div>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="service-content d-flex align-items-center justify-content-between">
                    <!-- Single Service Area -->
                    <div class="single-service--area mb-100 wow fadeInUp" data-wow-delay="300ms"><img alt="" src="/horizon/img/core-img/icon-5.png" />
                        <h5>Accommodation</h5>
                    </div>
                    <!-- Single Service Area -->

                    <div class="single-service--area mb-100 wow fadeInUp" data-wow-delay="500ms"><img alt="" src="/horizon/img/core-img/icon-3.png" />
                        <h5>Restaurant &amp; Bar</h5>
                    </div>
                    <!-- Single Service Area -->

                    <div class="single-service--area mb-100 wow fadeInUp" data-wow-delay="700ms"><img alt="" src="/horizon/img/core-img/icon-6.png" />
                        <h5>Laundry service</h5>
                    </div>
                    <!-- Single Service Area -->

                    <div class="single-service--area mb-100 wow fadeInUp" data-wow-delay="900ms"><img alt="" src="/horizon/img/core-img/icon-7.png" />
    ...
    <div class="rooms-slides owl-carousel">
        ...
        <div class="single-room-slide d-flex align-items-center">
            ...
            <div class="room-content">
                ...
                <a class="btn roberto-btn mt-30" data-animation="fadeInUp" data-delay="700ms" href="/room/{{ base64_encode($room->id) }}">View
                    Details</a>
            </div>
        </div>
        @endforeach
