            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title">Business Suite View</h2>
                        <h2 class="room-price">₦23,000 <span>/ Per Night</span></h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div id="room-thumbnail--slide" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="/horizon/img/business/b1.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="/horizon/img/business/b2.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="/horizon/img/business/b3.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="/horizon/img/business/b4.jpg" class="d-block w-100" alt="">
                                    </div>
                                </div>
