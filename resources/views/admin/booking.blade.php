...
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="dashboard_breadcam text-right">
                                    <p><a href="/admin/bookings">Dashboard</a> <i class="fas fa-caret-right"></i> Bookings</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="white_box mb_30">
                        ...
                        <div class="default-according col-lg-8 mx-auto" id="accordion">
                            <div class="card">
                                <div class="card-header mx-auto" id="headingOne">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link collapsed mx-10 btn btn-primary" data-toggle="collapse"
                                            data-target="#collapseOne" aria-expanded="false"
                                            aria-controls="collapseOne">Book a
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('staff-booking') }}" method="post">
                                                    ...
                                                    <div class="input-daterange" id="datepicker">
                                                        <div class="row no-gutters">
                                                            <div class="col-6">
                                                                ...
                                                                <input class="input-small form-control" id="checkin"
                                                                    name="check_in" type="datetime-local"
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <input class="input-small form-control" name="check_out"
                                                ...
                                                <div class="form-group mb-30"><label>Details</label>
                                                    ...
                                                    <div class="row no-gutters">
                                                        <div class="col-6"><input class="input-small form-control"
                                                        ...
                                                        <div class="col-6"><input class="input-small form-control"
                                                                name="phone" placeholder="Guest Phone No:"
                                                ...
                                                <div class="form-group mb-30">
                                                    <div class="row">
                                                        <div class="col"><input class="input-small form-control"
                                                                name="email" placeholder="Enter Guest Email:" type="text"
                                                                value="{{ old('email') }}" />
                                                            <span class="text-danger">
                                                                @error('email')
                                                                    {{ $message }}
                                                        ...
                                                        <div class="col-6"><label for="roomtype">Room Type</label>
                                                            <div>
                                                                <select class="form-control formselect required"
                                                                    placeholder="Select Category" name="room_type"
                                                                    id="sub_category_name">
                                                                    <option value="0" disabled selected>Select Room type
                                                                    </option>
                                                                    @if (isset($room_type))
                                                                        @foreach ($room_type as $type)
                                                                            <option
                                                                                value="{{ base64_encode($type->id) }}">
                                                                                {{ ucfirst($type->name) }}
                                                                            </option>
                                                                        @endforeach
                                                                    @endif
                                                ...
                                                <div class="form-group mb-50">
                                                    <div class="slider-range">
                                                        <div class="slider-range-price ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"
                                                            data-label-result="Max Price: " data-max="3000" data-min="0"
                                                            data-unit="$" data-value-max="3000" data-value-min="0">
                                                ...
                                                <div class="form-group"><button
                                                        class="btn roberto-btn w-100 btn-primary" type="submit">Book
                                                        Now</button></div>
                                            </form>
                                        </div>
                                    </div>
                        ...
                        <div class="QA_table mb_30">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="quantity mt-3" style="display: flex;">
                                                        ...
                                                        <a href="/admin/booking-details/{{ base64_encode($booking->id) }}"
                                                        ...
                                                        <form
                                                            action="/admin/approve-booking/{{ base64_encode($booking->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <input type="hidden" name="id"
                                                                value="{{ base64_encode($booking->id) }}">
                                                            <button type="submit"
                                                                class="btn btn-success px-4 d-inline-block ">
                                                                <i class="me-2"></i>Approve
                                                            </button>
                                                        </form>

                                                        <form
                                                            action="/admin/booking-details/update/{{ base64_encode($booking->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <input type="hidden" name="status" value="cancelled">
                                                            <button
                                                                onclick="return confirm('Are you sure you want to cancel this booking?')"
                                                                type="submit" class="btn btn-danger px-4 d-inline-block ">
                            ...
                            @if ($bookings->count() < 1)
                                <tr>No pending booking data available at the moment</tr>
                            @endif
                        </div>
                    </div>
                </div>
    ...
    <script>
            ...
            $('#sub_category_name').on('change', function() {
                ...
                $.ajax({
                    ...
                    error: function(XMLHttpRequest, textStatus, errorThrown) {
                        swal("Oops!", "An error occurred while getting availabel rooms!",
                            "error");
        ...
        var checkName = (function ask() {
            ...
            var name = prompt(
                "Please view the details of this booking before you approve or Enter your full name to Approve");
            if (name == "{{ Auth::user()->name }}") {
                ...
                if (name == '') {
                    ...
                    alert(
                        "You are not allowed to approve this booking, please contact admin or enter {{ Auth::user()->name }} to Approve");
