...
<div class="main_content_iner ">
    <div class="container-fluid p-0">
        ...
        @elseif ($features->count() > 1 && $features->count() < 3) 
        <div class="mb-5" style="display: flex; flex-direction: column; align-items: center;">
                <p class="text-warning">Some Room Feature are Available, But you can still add more room features that matches the available room and room type </p>
                <div>
                    <a class="btn btn-primary sm" href="/admin/roomfeatures">Add More Room Feature</a>
                </div>
    </div>
    @endif
                            ...
                            <div class="modal-body">
                                <form action="{{ route('room') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="name" class="form-control" placeholder="Room type Name, i.e Royal Suites">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="bed" class="form-control" placeholder="Type of Bed">
                                        <span class="text-danger">
                                            @error('bed')
                                            {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="no_of_rooms" class="form-control" placeholder="Number of Rooms Under this Room type, i.e 10">
                                        <span class="text-danger">
                                            @error('no_of_rooms')
                                            {{ $message }}
                                            @enderror
